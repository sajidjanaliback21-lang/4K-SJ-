...
export const TRENDING_REGIONS: TrendingRegion[] = [
  ...
  { code: 'SA', name: 'Saudi Arabia', subtitle: 'Gulf & Arabic Hits' },
  ...
  { code: 'CA', name: 'Canada', subtitle: 'North American Releases' },
  { code: 'AU', name: 'Australia', subtitle: 'Oceania & Global Cinema' },
  { code: 'BD', name: 'Bangladesh', subtitle: 'Bangla Cinema & Shows' },
  ...
  { code: 'IT', name: 'Italy', subtitle: 'Italian Cinema & Series' },
